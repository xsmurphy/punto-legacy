...
export const fixtureItems: PosItem[] = [
  ...
  // Bebidas con alcohol
  {
    ...
    sku: "CER-960",
    // El ÚNICO ítem del fixture con código de barras, y a propósito: un
    // producto envasado que el comercio revende viene con EAN de fábrica,
    // mientras que un plato de cocina (el resto de esta lista) no tiene
    // ninguno. Así el catálogo de prueba ejercita las dos ramas del resolver
    // —escaneo que pega y escaneo que no encuentra nada— sin inventarle un
    // código a una milanesa.
