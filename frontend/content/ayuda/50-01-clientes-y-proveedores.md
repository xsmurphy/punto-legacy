...
slug: clientes-y-proveedores
modulo: contactos
audiencia: administrativo
keywords: [clientes, proveedores, contactos, alta de cliente, alta de proveedor, direcciones, ficha de cliente, importar contactos, documento de identidad, ruc, cedula]
resumen: Cómo cargar y gestionar tus clientes y proveedores en Punto.
---
...
6. Si querés habilitarle venta a crédito a un cliente, activá esa opción y definí un tope de saldo si corresponde (ver [ventas a crédito y cobranzas](50-02-ventas-a-credito-y-cobranzas.md)).
7. Guardá.
...
**¿Puedo dar de baja un cliente o proveedor?**
Sí. Al darlo de baja, se archiva y deja de aparecer en las búsquedas normales, pero se conserva su historial de ventas o compras.

**¿Puedo tener dos clientes con el mismo número de documento cargado por error?**
