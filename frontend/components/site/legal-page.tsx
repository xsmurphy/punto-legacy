  ...
  return (
    <section id={id} className="scroll-mt-24">
      ...
      <h2 className="text-2xl font-semibold tracking-tight text-balance md:text-3xl">
        <span className="mr-2 tabular-nums text-muted-foreground">{numero}.</span>
        {t(seccion.titulo)}
      </h2>
...
export function LegalPage({ doc }: { doc: DocumentoLegal }) {
  return (
    <div className="pt-16">
      {/* Ancho de lectura acotado: un documento legal a max-w-6xl no se lee. */}
      <article className="mx-auto w-full max-w-2xl px-4 py-16 md:px-6 md:py-24">
        ...
        <nav
          ...
          className="mt-12 rounded-2xl border bg-muted/40 p-6"
        >
