...
function TabsTrigger({
  ...
  return (
    // NOTA: Radix marca el trigger activo con `data-state="active"`. El
    // preset venía con variantes `data-active:` (atributo inexistente en
    // esta versión) y el estado activo no se pintaba en ningún Tabs.
