...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        // w-full por paridad con <Input> (que es w-full por default): un Select
        // al lado de un Input en un formulario debe alinear el mismo ancho.
        // El ancho compacto es la EXCEPCIÓN (toolbars, filtros) y se pide
        // explícito con className="w-fit" en el call-site.
