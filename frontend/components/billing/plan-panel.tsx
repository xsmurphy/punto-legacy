...
// Panel de "Mi plan" — balance + plan + tabs internas (movimientos / comprar).
// Vive tanto en /history-billing (page standalone) como en una sección del
// modal /settings. El handler de `?checkout=success` queda en el page (es
// dependiente de URL), no acá.
