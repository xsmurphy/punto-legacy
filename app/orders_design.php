...
<head>  
  ...
  <link rel="stylesheet" href="/vendor.css?123" type="text/css" />
  ...
  <section class="col-xs-12 no-padder">
    ...
    <div id="myCarousel" class="carousel slide " data-ride="carousel" data-interval="false">
      ...
      <div class="carousel-inner">
        <div class="item active scrollable" style="height: 95vh;">
        ...
        <div class="item scrollable" style="height: 95vh;">
          ...
          <div class="col-xs-3 wrapper">
            <div class="col-xs-12 no-padder r-3x clear">
              ...
              <div class="col-xs-12 lter wrapper text-white">
                  <span class="minutes h4">09m</span> <span class="seconds h4">20s</span>
              </div>
            </div>
          </div>
    ...
    <div class="col-xs-12 wrapper bg">Barra de arriba</div>
