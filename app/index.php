...
<head>  
  ...
  <style>
        ...
        /* Media query para cuando el ancho de la ventana es menor a 768px */
        ...
        /* Media query para cuando el ancho de la ventana es igual o mayor a 768px */
...
<body class="noscroll">
  ...
  <!-- Stubs locales para trackers externos (mixpanel, gtag, grecaptcha) — sin red. -->
  <script type="text/javascript">
    var _noop = function(){};
    window.mixpanel = { init: _noop, identify: _noop, track: _noop, register: _noop, reset: _noop, people: { set: _noop, set_once: _noop, increment: _noop } };
    window.dataLayer = [];
    window.gtag = _noop;
    ...
    <section class="vbox no-padder m-t-lg clear no-bg md-whiteframe-6dp r-3x">
              ...
              <div class="panel-body no-bg wrapper">
                ...
                <form role="form" style="display: none;" id="loginForm" method="post" class="animated bounceIn">
                  ...
                  <div class="m-b-sm text-right">
                    <a href="/login?recover=1" class="text-primary clickeable" data-type="link" target="_blank">¿Olvidó su contraseña?</a>
                  </div>
                  <span class="text-u-c font-bold btn btn-info btn-rounded btn-lg m-t-sm m-b-sm" id="btn-login">Ingresar</span>
                </form>

                <form role="form" style="display: none;" id="newAccountForm" method="post" class="animated bounceIn" action="/user-register" method="POST">
                  ...
                  <div class="col-sm-12 text-center no-padder signUpStep3" style="display: none;">
                    ...
                    <div class="text-xs text-center m-t-md">Al presionar en <span class="text-u-c">Crear Empresa</span>, usted acepta nuestros <a href="/assets/terminos.pdf" class="text-primary clickeable" data-type="link" target="_blank">Términos y Condiciones</a></div>
      ...
      <div class="bg-light lt col-xs-12 noscroll" id="nomobile" style="display: none; height: 85vh;">
        ...
        <div class="col-sm-6 wrapper text-center" style="margin-top:10%;">
          ...
          <img src="/images/iconincomesm.png" class="m-b-sm" width="100">
      ...
      <div class="bg-light lt col-xs-12 noscroll hidden-print" id="preventMultiTabs" style="display: none; height: 85vh;">
        ...
        <div class="col-sm-6 wrapper text-center" style="margin-top:10%;">
          ...
          <img src="/images/emptystate4.png" height="140" id="encomIsRunning">
          ...
          <div class="text-muted m-t">
            ...
            <a href="/preguntas-frecuentes/puedo-realizar-ventas-en-varias-ventanas" class="btn btn-primary font-bold btn-lg text-u-c btn-rounded m-t ">Más información</a>
          </div>
      ...
      <div class="col-xs-12 no-padder noscroll fullheight animated fadeIn speed-3x r-3x hidden-print" id="register" style="display: none;">
        ...
        <div id="registerWrapper" class="clear col-xs-12 no-padder">
          <div id="menu2" class="fullheight col-xs-12 no-padder clickeable scrollable" data-type="hideMenu" style="display:none; position:absolute; left:0; z-index: 999;">
            ...
            <div class="col-xs-12 no-padder">
              ...
              <div class="col-lg-3 col-sm-4 wrapper hidden-xs animated delay-3ms speed-5x rightBlock">
                ...
                <div class="col-xs-12 wrapper m-b bg-black r-24x text-white text-right menuWidgetOffsetBgLogo" id="ncmMenuTime" style="background-image:url(/images/iconincomesm.png);">
                ...
                <div class="col-xs-12 wrapper m-b bg-black r-24x menuWidgetOffsetBgLogo" id="spotifyWidgetPlayerWrap" style="background-image:url(/assets/app/images/spotify.png);"></div>
          ...
          <div class="text-center hidden bg-danger text-white offlineMessage">
              <span> No estás conectado a internet <i class="material-icons md-20">signal_wifi_off</i></span>
          </div>
      ...
      <div class="bg-light lter fullheight animated slideInDown speed-3x col-xs-12 no-padder hidden-print" id="lockedAccount" style="display: none;">
        <div class="text-center" style="position:absolute;top:0;left:0;bottom:0;right:0;margin:auto;width:100%;max-width:530px;">
          <div>
            <img src="/assets/images/partialLock.png" style="max-height:280px;">
          </div>
      ...
      <div id="allModals">
        ...
        <!-- Modal printServer -->
        <div class="imodal animated speed-5x momentumit" style="display:none;" id="modalPrintServer">
          <div class="col-sm-3 col-lg-4 hidden-xs"></div>
            <div class="col-sm-6 col-lg-4 col-xs-12 text-center r-24x clear bg-white imodal-content md-whiteframe-12dp no-padder">
              <div class="col-xs-12 imodal-header no-padder visible-xs">
              </div>
              <div class="imodal-body col-xs-12 no-padder text-center" style="min-height: 200px;">
                    <h2 class="font-bold m-t-lg">Servidor de Impresión</h2>
          ...
          <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 col-xs-12 text-center r-24x imodal-content noPopup no-padder">
            ...
            <div class="imodal-body r-24x col-xs-12 wrapper">
              <form class="form" data-type="item" role="form">
                ...
                <div class="text-white col-xs-12 wrapper text-center font-normal hidden" id="encAutoCompleteMsg">Administra tus productos y servicios en <br> <a href="/@#items" class="h3 text-white clickeable" data-type="link"><?= APP_URL ?>/@#items</a></div>
                        ...
                        <div class="col-xs-12 momentumit panel r-24x no-padder">
                          ...
                          <div class="col-xs-12 no-padder" style="display: none;" id="ncmViewMoreCustomerForm"> 
                            ...
                            <div class="col-sm-6 col-xs-12" style="display: none;">
                              <div class="input-lg no-border m-t-sm">
                                <span class="pull-left">Diplomático</span>
                                <div class="switch-select switch pull-left m-l-sm" id="crdi" style="width: 55px!important;height: 30px!important;"> 
                                  <div class="swinner" style="width: 25px!important;height: 25px!important; top:2px!important;"> 
                                    <input type="checkbox" name="crdi"> 
                                  </div> 
                                </div>
                                </div>
                            </div>
            ...
            <div class="col-sm-4 col-xs-12 text-center bg-white clear r-24x imodal-content md-whiteframe-8dp no-padder">
              <div class="imodal-body col-xs-12 no-padder">
                ...
                <div class="col-xs-12 wrapper text-right visible-xs">
                  <a href="#" class="block imodalclose" style="background: url(/assets/images/modal_handle_dk.png) no-repeat center top">
            ...
            <div class="col-sm-6 col-xs-12 text-left bg-white clear r-24x imodal-content md-whiteframe-12dp no-padder">
              ...
              <div class="imodal-body col-xs-12 no-padder">
                <form class="form" data-type="editCustomer" role="form" id="editCustomerForm">
                  ...
                  <div class="col-md-12 input-lg" style="display: none;">
                    <div class="font-bold text-xs text-u-c m-b-n m-t-sm">
                      <span class="pull-left">Diplomático</span>
                      <div class="switch-select switch pull-left m-l-sm" id="ecrdi" style="width: 55px!important;height: 30px!important;"> 
                        <div class="swinner" style="width: 25px!important;height: 25px!important; top:2px!important;"> 
                          <input type="checkbox" name="ecrdi"> 
                        </div> 
                      </div>
                      </div>
                  </div>
          ...
          <div class="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 col-sm-10 col-xs-12 col-sm-offset-1 col-xs-12 text-center bg-white r-24x clear imodal-content md-whiteframe-12dp no-padder">
            ...
            <div class="imodal-body bg-white col-xs-12 no-padder clear">
              ...
              <div class="col-xs-12 no-padder text-center m-t m-b doc-buttons">
                ...
                <div class="btn btn-lg bg-info text-white rounded clickeable font-bold togglePixBtns hidden m-r-xs" data-coin="pix" data-type="paymentMethod" data-name="pix">
                  PIX <img src="/images/Logo_pix_icon.svg" class="logoPix" style="height:1.0em;" alt="Pix">
                </div>
              ...
              <div class="col-xs-12 no-padder m-b doc-buttons" id="currenciesList" style="display:none;">
              </div>
        ...
        <div class="imodal animated speed-5x noscroll wrapper" data-backdrop="1" style="display:none;" id="modalTutorial">
            <div class="col-sm-8 col-sm-offset-2 col-xs-12 text-center r-24x clear text-white noPopup imodal-content no-padder">
              ...
              <div class="imodal-body col-xs-12 no-padder text-center">
                <a href="" class="col-xs-12 no-padder clickeable" data-type="link">
                  <img src="/assets/images/onboard_desktop.jpg" width="100%" class="hidden-xs r-24x">
                  <img src="/assets/images/onboard_mobile.jpg" width="100%" class="visible-xs r-24x">
                </a>
              </div>
            </div>
        </div>
            ...
            <div class="imodal-body col-xs-12 no-padder">
              ...
              <div class="col-sm-6 no-padder hEightyP bg-light dk momentumit" id="getSalesDataHolder">
                  ...
                  <div class="modalInfoBlock text-center wrapper-lg" id="saleTableDataMsg" style="margin-top: 18%;">
                    <a href="/otros-modulos/app-para-android-y-ios" class="clickeable" data-type="url"> 
                      <img src="/assets/images/encom_app.png" class="img-circle" width="280"> 
                    </a>
              ...
              <div class="col-sm-6 col-xs-12 no-padder">
                  <div class="h2 font-bold m-l wrapper-md">
                    ...
                    <span class="pull-right">
                      ...
                      <span class="btn btn-icon btn-rounded btn-default m-r-sm m-b-sm clickeable hidden-mobile" data-type="notificationsBtn" data-toggle="tooltip" data-original-title="Activar Notificaciones" data-placement="left">
                  ...
                  <div class="col-xs-12 wrapper">
                    ...
                    <div class="col-xs-6 no-padder">
                      <input type="text" class="form-control no-border no-bg text-right b-b font-bold text-lg" name="" id="ipBancard" placeholder="Ej: 192.168.101.68">
                    </div>
                  </div>
  ...
  <div id="incomeSpinner" class="rounded animated bounceIn text-center" style="display: none; width: 75px; height: 75px; top:50%; left:50%; margin:-37px 0 0 -37px; position: absolute; z-index:1000; overflow:hidden;">
    <img src="/images/svg-loaders/puff.svg" width="60">
  </div>
  ...
  <!-- Google Analytics removido — stubs declarados en el <head>. -->
  <script>
    if (typeof ga !== 'function') { var ga = function(){ return false; }; }
  </script>
  ...
  <?php
    ...
    if($get['i']){
      ...
      if($companyId && $outletId){
        ?>
        <script type="text/javascript" src="/assets/vendor/js/simpleStorage-0.2.1.min.js"></script>
        <script type="text/javascript">
          ...
          if(oldCompanyId == newCompanyId){
            window.location.href = "<?= $_SERVER['REQUEST_SCHEME']."://".$_SERVER['HTTP_HOST']?>";
          }else{
            simpleStorage.flush();
  ...
  <script id="drawerTpl" type="text/html">
    ...
    <div class="text-center col-xs-12">
      <img id="openClosedSign" src="/images/transparent.png" height="70" class="m-b-md m-t-md"> 
    </div>
    ...
    <div class="col-xs-12 wrapper">
      ...
      <div class="col-xs-12 no-padder text-left">
        <div class="col-xs-12 no-padder pointer r-3x clear {{#default}}b-l b-5x b-info{{/default}} m-b bg-white customerAddressSetDefault" data-id="{{id}}" data-customer-id="{{customerId}}" id="customerAddressLine{{id}}">
          ...
          {{#default}}{{#latlng}}
          <iframe class="m-b-n-sm" width="100%" height="120" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="/screens/mapIframe?height=120&lat={{lat}}&lng={{lng}}&theme={{theme}}&zoom=17&key={{key}}"></iframe>
          {{/latlng}}{{/default}}
          <div class="col-xs-12 wrapper">
            <div class="col-xs-12 no-padder">
        ...
        <div class="col-xs-12 wrapper r-3x b m-b bg-white hidden customerAddressLineEdit" id="customerAddressLineEdit{{id}}">
          ...
          <div class="col-xs-12 no-padder m-t customerAddressMapView{{id}}">
            ...
            <iframe width="100%" height="200" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="/screens/mapIframe?height=200&lat={{lat}}&lng={{lng}}&theme={{theme}}&zoom=15&key={{key}}"></iframe>
  ...
  <script id="qrPaymentTpl" type="text/html">
    <div class="col-xs-12 no-padder text-center">
      ...
      <div class="col-xs-12 text-sm">
        ...
        <div class="btn btn-info btn-rounded font-bold text-u-c btn-md m-b-md" style="margin-bottom: 20px" id="verificarPagoQRBtn">Verificar pago QR</div>
      ...
      <div class="col-sm-10 col-xs-12 col-sm-offset-1 wrapper">
        <div class="h3 font-bold text-center m-t m-b">Código de confirmación</div>
        <div class="input-group">
  ...
  <script id="qrPixPaymentTpl" type="text/html">
    <div class="col-xs-12 no-padder text-center">
      {{^pixDatas}}
      {{#img}}
      ...
      {{/img}}
      {{^img}}
      <iframe src="{{qr}}&width=300" width="100%" height="350px" style="width:100%; height: 350px; border:0; padding:0; margin:0;"></iframe>
      {{/img}}

      <p class="h4 font-bold text-left wrap-l-lg">Total en Gs.: <span style="float: right;" class="wrap-r-lg">{{ventaGs}}</span></p>
      <hr class="m-xs">
      <p class="h4 font-bold text-left wrap-l-lg">Valor U$D: <span style="float: right;" class="wrap-r-lg">{{ventaDolar}}</span></p>
      <hr class="m-xs">
      <p class="h4 font-bold text-left wrap-l-lg">Valor en R$: <span style="float: right;" class="wrap-r-lg">{{ventaReal}}</span></p>
      <hr class="m-xs">
      ...
      {{#pixDatas}}       
      <div class="col-sm-10 col-xs-12 col-sm-offset-1 wrapper">
        <div class="h4 font-bold text-center m-t m-b">Ingrese el CPF del cliente</div>
          <input type="text" class="form-control text-lg text-center font-bold input-lg rounded" placeholder="CPF" id="PixCpfInput">
        <div class="m-t">
          <a href="#" class="btn btn-info btn-rounded font-bold text-u-c btn-lg m-b-md" id="PixPaymentBtnSubmit">Enviar</a>
        </div>
      </div>
      {{/pixDatas}}
    </div>
  ...
  <div style="font-family: 'fakereceipt'; height:1px!important; overflow: hidden;"><?= APP_URL ?></div>
