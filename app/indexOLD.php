...
?>
<!DOCTYPE html>
<html class="noscroll bg-light dker">
<head>  
  <meta charset="utf-8" />
...
<body class="noscroll">
  ...
  <section class="container no-padder" style="width:100%!important; max-width:1396px!important; min-height: 100vh;">
    <section class="vbox no-padder m-t-lg clear no-bg md-whiteframe-6dp r-3x">
            ...
            <section class="panel panel-default bg-white m-n r-24x no-border animated bounceInUp">
              <div class="panel-body no-bg wrapper">
                ...
                <div class="text-center" id="welcome">
                  ...
                  <div>¿Ya tienes una cuenta en ENCOM? <br> <a href="#" class="text-info text-u-l text-primary font-bold" id="toLoginBtn">Ingresa aquí</a> </div>
                </div>
      ...
      <!--LOCK-->
      <div class="bg-light lter fullheight animated slideInDown speed-3x col-xs-12 no-padder hidden-print" id="lock" style="display: none;">
        <a href="#" class="btn btn-dark m-l m-t btn-rounded text-u-c clickeable hidden" id="asistanceScreenBtn" data-type="clocking"><i class="material-icons m-r-xs">timer</i>Asistencia</a>
        <a href="#" class="btn btn-default m-l m-t btn-rounded text-u-c clickeable hidden" id="lockScreenBtn" data-type="logout"><i class="material-icons m-r-xs">fingerprint</i>Lockscreen</a>
      ...
      <div class="col-xs-12 no-padder noscroll fullheight animated fadeIn speed-3x r-3x hidden-print" id="register" style="display: none;">
        ...
        <div id="registerWrapper" class="clear col-xs-12 no-padder">
          <div id="menu" class="fullheight col-xs-12 no-padder clickeable scrollable" data-type="hideMenu" style="display:none; position:absolute; left:0; z-index: 999;">

            <div class="col-xs-12 no-padder">

              <div class="col-lg-3 col-sm-4 col-xs-12 wrapper animated speed-5x leftBlock">
                <div class="col-xs-12 wrapper m-l-n-lg m-b bg-black r-24x text-white text-center">
                  <div class="col-xs-12 no-padder" id="ncmMenuListBlock">

                    <div class="m-t-n row">
                      <div class="col-xs-6 wrapper text-left clickeable visible-xs" data-type="goToPageMenu">
                        <a href="#" class="block wrap-l-lg">
                      ...
                      <div class="col-xs-6 wrapper text-right clickeable" data-type="hideMenu">
                        <a href="#" class="block">
                    ...
                    <div class="col-xs-12 clickeable m-b m-t-n" data-type="hideMenu"> 
                      <a href="#menu&a=hide" class="thumb-lg m-t rounded navigate" id="companyLogo"> 
                        <img src="" class="img-circle" id="companyImg"> 
                      </a>
                      <div class="text-sm"> 
                        <div class="h3 m-t-xs m-b-xs text-white" id="companyName"></div>
                        <div class="outletAndRegisterText"></div>
                        <i class="block userName"></i> 
                      </div>
                    </div> 

                    <div class="col-xs-12 no-padder b-b b-black"></div>              
                  
                    <div class="col-xs-12 no-padder font-bold h4 text-u-c m-t animated fadeInUp speed-4x">

                      <a href="#drawer" class="wrapper m-b-sm hide-basic block navigate" id="drawerControlBtn" style="display:none;">
                        Control de Caja
                      </a>

                      <a href="#transactions" class="wrapper m-b-sm menuTransactionToggleBtn block navigate"> 
                        Transacciones
                      </a>

                      <a href="#openQuotes" class="wrapper m-b-sm menuQuoteToggleBtn hidden block navigate"> 
                        Cotizaciones
                      </a>

                      <a href="#openAgenda" class="wrapper m-b-sm menuAgendaToggleBtn block navigate"> 
                        Agenda
                      </a>

                      <a href="#openOrders" class="wrapper m-b-sm menuOrdersToggleBtn block navigate"> 
                        Órdenes
                      </a>

                      <a href="#settings" class="wrapper m-b-sm visible-high block navigate" id="settingsMenuBtn" > 
                        Ajustes
                      </a>

                      <a href="#lock" class="wrapper m-b-sm block navigate" id="salirBtn" data-animation="bounceIn"> 
                        Salir <span class="text-muted text-sm font-thin hidden-xs">(ESC)</span>
                      </a>
                    </div>

                  </div>

                  <div id="ncmMenuListBlockSpacer"></div>

                  <div class="col-xs-12 text-center">

                    <span class="btn btn-icon clickeable m-b-xs m-r animated fadeInRight speed-3x delay-5ms hidden-sm hidden-md hidden-lg" data-type="refreshDB" data-animation="bounceIn">
                        <i class="material-icons text-white">refresh</i>
                    </span>


                    <span class="btn btn-icon clickeable m-b-xs animated zoomIn speed-5x delay-4ms" data-type="syncList" data-animation="bounceIn">
                      <span class="connectionStatus">
                        <i class="material-icons text-warning md-24">&#xe1ba;</i>
                      </span>
                    </span>

                    <span class="btn btn-icon clickeable m-b-xs m-l animated fadeInLeft speed-3x delay-5ms hidden-sm hidden-md hidden-lg" data-type="tutorial" data-animation="bounceIn">
                        <i class="material-icons text-white">live_help</i>
                    </span>

                    <span class="btn btn-icon clickeable m-b-xs m-l animated fadeInLeft speed-3x delay-5ms hidden-sm hidden-md hidden-lg" data-type="darkMode" data-animation="bounceIn">
                        <i class="material-icons text-white">brightness_medium</i>
                    </span>

                    <div class="text-muted m-t-sm">Versión <span class="appVersionCachedInHTML"><?=APP_VERSION?></span></div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-3 col-sm-4 wrapper hidden-xs animated delay-3ms speed-5x rightBlock">
                ...
                <div class="col-xs-12 no-padder text-right m-b">
                  ...
                  <a href="#" class="clickeable btn btn-icon btn-dark btn-lg bg-black r-24x m-l-xs" data-type="darkMode" data-animation="bounceIn">
                    <span class="material-icons md-24">brightness_medium</span>
                  </a>

                  <a href="#" class="clickeable btn btn-icon btn-dark btn-lg bg-black r-24x m-l-xs" data-type="tutorial" data-animation="bounceIn">
                  ...
                  <a href="#" class="clickeable btn btn-icon btn-dark btn-lg bg-black r-24x m-l-xs" data-type="goFullScreen" title="Modo pantalla completa" data-toggle="tooltip" data-placement="left" data-animation="bounceIn">
          ...
          <div id="modulesBtn" class="text-center col-xs-12 no-padder animated bounceIn">
            <div style="display: none;" id="modulesMenu">
              ...
              <a href="#orders_module" class="btn btn-rounded btn-lg btn-icon bg-dark dker text-white no-border md-whiteframe-6dp m-b ordersModulesBtn animated speed-5x delay-1ms zoomIn navigate" data-toggle="tooltip" data-original-title="Órdenes" data-placement="right"><i class="material-icons">&#xe1b2;</i></a>
          ...
          <div class="col-sm-8 bg-light no-padder momentumit fullheight hidden-xs animateSizeChange" id="hotkeys">
          </div>

          <div class="col-sm-4 col-xs-12 no-padder b-l b-light" id="sidebar">

            <div class="text-center bg-light dker no-padder col-xs-12" id="foot">
            ...
            <div class="col-xs-12 no-padder bg-light BPBPhone">
              <div class="text-center col-xs-12 no-padder bg-light"> 
            ...
            <div id="mobileItemsList" class="col-xs-12 no-padder bg-light">
      ...
      <div class="fullheight noscroll animateBg gradBgBlue col-xs-12 no-padder hidden-print" id="confirmScreen" style="display:none;">
        ...
        <div class="col-sm-6 col-md-4 col-xs-12 wrapper-sm text-white text-center verticalAlign" data-height="323">
          ...
          <div class="row">
            <a href="#" class="btn btn-default btn-s-md btn-rounded btn-lg m-t m-r no-border font-bold clickeable confirmTools animated navigate" data-type="printOptions" data-toggle="tooltip" data-original-title="Imprima desde el listado de impresoras"><span>IMPRIMIR</span></a>
            
            <a href="#" class="btn btn-default btn-s-md btn-rounded btn-lg m-t no-border font-bold clickeable confirmTools animated navigate" data-type="createNewSale" data-toggle="tooltip" data-original-title="Volver a la pantalla de ventas, también puede presionar la tecla ESC"><span>ATRÁS</span></a>
          </div>

          <div class="row">
            <a href="#" class="btn btn-default btn-s-md btn-rounded hidden btn-lg m-t no-border font-bold clickeable confirmTools animated navigate" data-type="createSaleOrder" data-toggle="tooltip" data-original-title="Generar una orden de esta venta"><span>ORDENAR</span></a>
          </div>
      ...
      <div id="allModals">
        ...
        <!--Action sheet-->
        <div class="col-xs-12 no-padder bg-black-opacity-2 animated fadeInUp speed-5x asClose momentumit" id="actionSheet" style="display:none;position:absolute;bottom:0;z-index: 1003;">
            ...
            <div class="col-sm-6 col-xs-12 noPopup text-center r-24x imodal-content no-padder">
              ...
              <div class="imodal-body r-24x col-xs-12 wrapper">
                <form class="form" data-type="customerSearchBar" role="form">
                  <input type="search" class="form-control input-lg bg-white rounded no-border text-center font-bold block" placeholder="Buscar clientes" id="customerInputSearch" autocomplete="off" style="font-size:25px; height:55px;" tabindex="1">
                </form>
                    ...
                    <form class="form" data-type="customer" role="form" id="addCustomerForm">
                      ...
                      <div class="bg-light bg col-xs-12 wrapper text-left" id="addCustomerFormHead"> 
                        ...
                        <div class="col-sm-5 no-padder text-right m-t-sm">  
                          ...
                          <input class="btn btn-info btn-rounded btn-lg clienteSubmit font-bold text-u-c m-t m-b" type="submit" value="Crear Cliente">
          ...
          <div class="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 col-sm-10 col-xs-12 col-sm-offset-1 col-xs-12 text-center bg-white r-24x clear imodal-content md-whiteframe-12dp no-padder">
            ...
            <div class="imodal-body bg-white col-xs-12 no-padder clear">
              ...
              <div class="col-xs-12 no-padder text-center m-t m-b doc-buttons">
                <div class="btn btn-lg btn-info rounded btn-s-md clickeable text-u-c font-bold" data-coin="cash" data-type="paymentMethod" data-name="Efectivo">Efectivo <small class="hidden-sm hidden-xs font-normal">(A)</small></div>
                <div class="btn btn-lg btn-default rounded btn-s-md clickeable text-u-c font-bold" data-coin="creditcard" data-type="paymentMethod" data-name="T. Crédito">T. Crédito <small class="hidden-sm hidden-xs font-normal">(S)</small></div>
                <div class="btn btn-lg btn-default rounded btn-s-md clickeable text-u-c font-bold" data-coin="debitcard" data-type="paymentMethod" data-name="T. Débito">T. Débito <small class="hidden-sm hidden-xs font-normal">(D)</small></div>
                <div class="btn btn-lg btn-default rounded btn-s-md clickeable text-u-c font-bold" data-coin="check" data-type="paymentMethod" data-name="Cheque">Cheque <small class="hidden-sm hidden-xs font-normal">(F)</small></div>
              ...
              <div class="col-xs-12 no-padder animated bounceIn m-b doc-buttons" id="customPaymentList" style="display:none;">
        ...
        <div class="imodal animated speed-5x noscroll wrapper" data-backdrop="1" style="display:none;" id="modalMensaje">
            ...
            <div class="col-sm-4 col-sm-offset-4 col-xs-12 text-center text-white imodal-content no-padder">
        ...
        <div class="imodal animated speed-5x momentumit" style="display:none;" id="modalOrders">
            ...
            <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-12 text-center bg-white clear r-24x imodal-content md-whiteframe-12dp no-padder">
              <div class="col-xs-12 imodal-header no-padder visible-xs">
              </div>
              <div class="imodal-body col-xs-12 wrapper">
  ...
  <script id="drawerTpl" type="text/html">
    ...
    <div id="loadExternalDrawerList" class="hide-low blindDrawer wrapper-sm">
      
    </div>

    <div class="closeRegister m-r"> 
      <a href="#" data-type="closeRegister" class="btn btn-lg btn-danger btn-rounded m-t clickeable text-u-c font-bold m-r-lg">Cerrar Caja</a> 
      <a href="#" class="btn m-t clickeable font-bold hide-low text-u-c" data-toggle="tooltip" data-original-title="Extraer dinero de la caja, lo extraído aparecerá en los reportes de gastos" data-type="extractMoney">Extraer</a>
    </div>
    <a href="#" style="display:none" data-type="openRegister" class="btn btn-lg btn-info btn-rounded m-t clickeable openRegister text-u-c font-bold animated fadeIn">Abrir Caja</a>
    <div class="col-xs-12 wrapper text-center hide-low blindDrawer"> 
      <a href="#" id="printClosure">Imprimir</a>
    </div> 
  </script>

  <script id="drawerInTpl" type="text/html">
    <div class="hide-low panel wrapper-sm r-3x">
      <h4 class="block text-center blindDrawer font-bold">{{date}}</h4>
      ...
      <table class="table text-left">
        ...
        <tfoot>
          ...
          <tr class="font-bold h3">
            ...
            <td class="text-right drawerExpected" data-raw="{{rawTotal}}">
              {{total}}
            </td>
          </tr>
        </tfoot>
  ...
  <script type="text/html" id="ordersPanelTableTpl">
      <div class="col-xs-12 wrapper">
        <input type="search" class="form-control bg-light dk no-border rounded input-lg datatableFilter" placeholder="Buscar órdenes activas" value="" autocomplete="off">
      </div>
  ...
  <script type="text/html" id="ordersPanelHolderTpl">
    {{{panelHolder}}}
    <div class="col-xs-12 no-padder panel bg-light lter momentumit" id="ordersPanelList" style="min-height:{{minHeight}};"></div>
    ...
    <div class="wrapper-xs col-xs-12 floatingModuleOpsWrap animated fadeInUp speed-5x" style="top:{{top}}; display:none;">
      ...
      <div class="col-sm-10 col-xs-12 rounded dker md-whiteframe-4dp no-border wrapper-xs clear momentumit" style="white-space:nowrap;">
        <div style="white-space: nowrap; min-width: 690px; max-height: 50px;">
          <a href="#" class="btn font-bold ncmOrdersPanelFilter" data-status="all">Todos <span class="badge bg-default m-l-xs oPFBtnAll">0</span></a>
          <a href="#" class="btn font-bold ncmOrdersPanelFilter" data-status="pending">Pendientes <span class="badge bg-default m-l-xs oPFBtnNew">0</span></a>
          <a href="#" class="btn font-bold ncmOrdersPanelFilter" data-status="waiting">En Espera <span class="badge bg-default m-l-xs oPFBtnWait">0</span></a>
          <a href="#" class="btn font-bold ncmOrdersPanelFilter" data-status="processing">En Proceso <span class="badge bg-default m-l-xs oPFBtnGoing">0</span></a>
          <a href="#" class="btn hidden font-bold ncmOrdersPanelFilter" data-status="finished">Finalizados <span class="badge bg-default m-l-xs oPFBtnEnd">0</span></a>
          <a href="#" class="btn font-bold ncmOrdersPanelFilter" data-status="delivered">Enviado <span class="badge bg-default m-l-xs oPFBtnSent">0</span></a>
          {{{expand}}}
          <a href="#" class="btn font-bold ncmOrdersPanelFilter pull-right hidden-android" data-status="map"><i class="material-icons">pin_drop</i></a>
        </div>
      </div>
  </script>
  ...
  <script id="transactionTpl" type="text/html">
    ...
    <div class="dk col-xs-12 wrapper text-left">
      {{#latLng}}
      ...
      <div class="col-xs-12 wrapper-sm panel momentumit panel r-3x m-b-xl table-responsive no-border {{#items}}{{/items}}{{^items}}hidden{{/items}}" id="saleViewTable">
        <table class="table text-left font-bold">
          <tbody>
            ...
            {{#itemNote}}
            <tr>
              <td colspan="4" class="font-normal"><em>{{itemNote}}</em></td>
            </tr>
            {{/itemNote}}
            {{/items}}
          </tbody>
    ...
    <div class="col-xs-12 no-padder inthelist hoverable" data-type="toggle" data-position="{{index}}">
      ...
      <div class="second col-xs-12 no-padder text-center dker speed-5x animated zoomIn" style="display:none;">
        ...
        <div class="col-xs-12 no-padder">
          ...
          <span class="pointer col-xs-3 change h4 wrapper-lg  bg-light dk animated itemInListDisplayBtn itemInList{{index}}" data-type="count" data-position="{{index}}" data-number="{{qtyRaw}}" data-toggle="tooltip" data-placement="bottom" data-animation="bounceIn" data-original-title="Modificar Cantidad">
            x{{qty}}
          </span>
  ...
  <script id="allOrdersTpl" type="text/html">
    {{#hasData}}
    <div class="h1 font-bold">{{title}}</div>
    <div class="col-xs-12 text-sm text-center m-b">{{subtitle}}</div>
      ...
      <table class="table">
        <tbody>
          ...
          <tr class="text-right text-md {{strike}} {{itemId}}-{{index}}">
            <td width="13%" class="font-bold">{{count}}</td>
            ...
            <td width="10%">
              <a href="#" class="clickeable {{hideX}}" data-type="removeItemFromOrder" data-id="{{itemId}}" data-position="{{index}}" data-oid="{{transactionId}}" data-table="{{table}}">
    ...
    <div class="col-xs-12 wrapper-sm text-center">
      <a href="#" class="clickeable btn m-t-xs font-bold text-u-c" data-type="printTable" data-kind="{{type}}" data-position="{{orderId}}">Imprimir</a>
    </div>
    <div class="col-xs-12 wrapper">
      <a href="#" class="clickeable btn m-t-xs font-bold text-u-c pull-left" data-type="addOrder" data-kind="{{type}}" data-position="{{orderId}}">Agregar Orden</a>

      <a href="#" class="clickeable btn btn-lg btn-info rounded font-bold text-u-c pull-right m-r" data-type="closeTable" data-kind="{{type}}" data-position="{{orderId}}">Procesar</a>
    </div>
    {{/hasData}}
    {{^hasData}}
      <div class="wrapper h2 font-bold m-t m-b">No posee órdenes</div> 
      <a href="#" class="btn btn-success gradBgGreen btn-lg btn-rounded m-t clickeable font-bold text-u-c" data-type="addOrder" data-kind="customer" data-position="{{orderId}}">Agregar orden</a>
    {{/hasData}}
