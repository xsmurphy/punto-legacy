...
$outlets = [];
$activeOutletName = '';
// Coords de la sucursal activa (mig 14: `lat`/`lng` NUMERIC, reemplazaron
// `outletLatLng`). Las consume el mapa de /pos/ordenes para pintar el PIN del
// local. Pueden ser NULL si la sucursal nunca cargó ubicación.
