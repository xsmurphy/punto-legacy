...
final class TransactionsService
{
    ...
    public function detail(array $filters, $from, $to, string $roc, string $companyId): array
    {
        ...
        foreach ($res as $f) {
            ...
            // Ancho del TALONARIO de este documento (mig 158). La devolución
            ...
            $rows[] = [
                ...
                // Formateador único (mig 158): mismo string que imprime el
     ...
     * cómo se separaron los tres `str_pad` que la mig 158 viene a unificar.
     *
     ...
     *
     * `padWidth` es un mapa docType → ancho (mig 158), no un escalar: el ancho
    ...
    public function registerInfo(array $ids, string $companyId): array
    {
        ...
        foreach ($res as $r) {
            ...
            $map[(string) $r['registerId']] = [
                ...
                // `document_sequence.padwidth` por la mig 158 y esta es la
