...
final class RegisterAdminService
{
        ...
        if ($rs && is_object($rs)) {
            while (!$rs->EOF) {
                ...
                $out[$id][$dt] = [
                    ...
                    // Ancho de impresión del correlativo (mig 158). El número
        ...
        if ($rs && is_object($rs)) {
            while (!$rs->EOF) {
                ...
                $out[] = [
                    ...
                    // (mig 158). Va aparte de `numbering` a propósito: el
    ...
    public function update(string $id, array $fields): array
    {
        ...
        // ── Ancho de impresión del correlativo (mig 158) ────────────────────
    ...
    private function seedSequence(
        ...
        // se tocó", y en el INSERT cae al DEFAULT legal de la mig 158 (7).
