...
final class ReturnService
{
    ...
    public function create(
        ...
        try {
            ...
            foreach ($items as $item) {
                ...
                $processedItems[] = [
                    ...
                    'restock'        => $restock,
                    // D8 (mig 158) — congelados, copiados de la línea original.
                    'taxRate'        => $origTaxRate,
                    'taxKind'        => $origTaxKind,
        ...
        // context/48-escalamiento-de-datos.md (mig 158): kind='devolucion'
        // vive DENTRO de 'sales'/'item_sales'/'payments' (mig 158 absorbió
