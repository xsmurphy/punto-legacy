...
-- físicos lowercase y el wrapper DB (api/includes/lib/DB.php) arma el INSERT con
-- las keys del array sin comillas (Postgres las pliega a minúscula). Crearla como
-- "drawerId" entre comillas la haría case-sensitive e inaccesible → ver mig 71.
