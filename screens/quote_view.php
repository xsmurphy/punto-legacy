...
$customerName 	= getValue('contact', 'contactName', 'WHERE contactId = '.$result['customerId']);
$customerRuc 	= getValue('contact', 'contactTIN', 'WHERE contactId = '.$result['customerId']);
		...
		<div class="col-xs-12 text-left wrapper">
			...
			<div class="col-xs-12 text-center">
				<div class="m-t m-b-lg" id="encom">
				   	<a href="/?utm_source=saas_online_receipt&utm_medium=saas_footer_icon&
