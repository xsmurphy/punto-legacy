      ...
      <div class="col-xs-12 no-padder hidden-print">
          ...
          if(validity($data)){
            ...
            foreach($data as $catId){
              if(validity($catId)){
                $item   = ncmExecute('SELECT itemName, itemId, itemSKU FROM item WHERE itemIsParent < 1 AND itemStatus > 0 AND itemTrackInventory > 0 AND categoryId = ?', [dec($catId)],false,true);
                ...
                if($item){
                  ...
                  <div class="col-xs-12 wrapper-md text-center font-bold h4">
                    <img src="/assets/images/emptystate7.png" height="110" class="m-b">
            ...
            echo noDataMessage("No se seleccionaron categorías","Debe seleccionar las categorías que desea inventariar","/assets/images/emptystate7.png");
          }
...
<?php
loadCDNFiles(['/assets/vendor/js/sweetalert2-7.33.1.min.js','https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.16.2/xlsx.full.min.js'],'js');
?>
<script>
