...
$settings = $db->Execute("SELECT * FROM company WHERE companyId = ?",array(COMPANY_ID));
...
<head>
  ...
  <link rel="stylesheet" href="/assets/vendor/css/animate-3.5.2.min.css" type="text/css">
  <link rel="stylesheet" href="/assets/vendor/css/bootstrap-datetimepicker-4.17.45.min.css" type="text/css">
  <!-- /core styles -->
...
<script type="text/javascript" src="/assets/vendor/js/fastclick-1.0.6.min.js"></script>
<script type="text/javascript" src="/assets/vendor/js/moment-2.24.0-with-locales.min.js"></script>
<script type="text/javascript" src="/assets/vendor/js/bootstrap-datetimepicker-4.17.47.min.js"></script>
<script>
