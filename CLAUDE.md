...
| **KuDE propio (renderer A4 + emisión propia)** | `73-kude-propio.md` (K1-K3 implementadas 2026-09-07 — renderer A4 con `@react-pdf` en `/api/kude/render` con `INTERNAL_RENDER_KEY`, caché S3, fallback a `getkude`, XML firmado archivado a S3 al aprobar; K5 emisión propia queda documentada ahí) |
