...
/**
 * Form de pairing — solo se monta cuando page.tsx (server component) verificó
 * que existe cookie panel. Defensa en profundidad: si la cookie está pero es
 * inválida/expirada, useBootstrap da 401 y redirige a login también.
 */
export function PosPairForm() {
  ...
  // Mientras carga o no hay data válida: no renderear form (evita flash con datos parciales).
