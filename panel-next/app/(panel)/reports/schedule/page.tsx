...
/**
 * Reporte Agendamientos — espejo de panel/reports/schedule.html.
 *
 * Backend: GET /v1/reports/schedule?view=detail&from=&to=
 * → { rows: [...], summary: { new, ended, cancelled, noshow, blocked, totals } }
 *
 * Reporte date-scoped. Muestra las citas del período con su estado.
 * El legacy también tenía Sesiones y Estadísticas (tabs) — acá exponemos
 * la vista "detail" (principal) como tabla.
 */
