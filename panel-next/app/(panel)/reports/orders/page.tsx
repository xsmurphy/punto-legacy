...
/**
 * Reporte de Órdenes — las órdenes son transaction type=12 (mismo origen que
 * el widget de órdenes del dashboard). Backend: GET /v1/reports/orders?from=&to=
 *
 * Date-scoped. Tabla de órdenes del período con su estado y canal.
 */
...
// transactionStatus → label/variant (mapa de panel/API/get_orders.php). Monocromático.
