...
<body class="bg-light lter">
  ...
  <div class="col-xs-12 text-center m-t-lg">
    <a href="#" class="thumb-md"> <img src="https://assets.encom.app/150-150/0/<?=enc(COMPANY_ID)?>.jpg" class="img-circle"> </a>
    ...
    <div class="col-xs-12 no-padder">
      ...
      <div class="col-sm-8 no-padder">
        ...
        <div class="col-xs-4 m-b-sm level pointer wrapper r-24x" data-level="1">
          <img src="https://panel.encom.app/images/badface.png" class="m-t" style="max-width:75%">
        ...
        <div class="col-xs-4 m-b-sm level pointer wrapper r-24x" data-level="3">
          <img src="https://panel.encom.app/images/goodface.png" style="max-width:90%">
        ...
        <div class="col-xs-4 m-b-sm level pointer wrapper r-24x" data-level="2">
          <img src="https://panel.encom.app/images/mediumface.png" class="m-t" style="max-width:75%">
