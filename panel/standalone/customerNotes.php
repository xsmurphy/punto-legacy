    ...
    <div class="col-xs-12 wrapper bg-light lter"> 
      ...
      <?php
        ...
        <div class="col-xs-12 wrapper text-center hidden-print">
          <a href="https://public.encom.app/customerNotes?s=<?=$_GET['s']?>" class="nativeA" target="_blank">Ver versión independiente</a>
        </div>
...
<?php
loadCDNFiles(array('https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.1.6/Chart.min.js'),'js');
?>
<script>
