...
$_modules = ncmExecute('SELECT * FROM module WHERE companyId = ?',[COMPANY_ID]);
	...
	<section class="col-lg-8 col-lg-offset-2 col-xs-12 no-padder">
		...
		<div class="col-xs-12 text-left wrapper">
				...
				<table class="table col-xs-12 no-padder m-b">
					...
					<tr>
						...
						<td class="hidden-xs hidden-sm hidden-md">
							<img src="https://assets.encom.app/60-60/0/<?=enc(COMPANY_ID) . '_' . $value['itemId'] ?>.jpg" height="40">
						</td>
						<td class="hidden-xs hidden-sm hidden-md">
							<?=$value['sku'];?>
						</td>
			...
			<div class="text-center wrapper col-xs-12">
				...
				<img src="https://api.qrserver.com/v1/create-qr-code/?size=80x80&amp;data=https://public.encom.app/quoteView?s=<?=$_GET['s']?>" width="80">
			</div>
		...
		<?php
		footerInjector();
		loadCDNFiles(['https://ncmaspace.nyc3.cdn.digitaloceanspaces.com/assets/scripts/ncmDropbox.min.js'],'js');
		?>	
	</section>
