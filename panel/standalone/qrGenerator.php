...
<script>
    $(document).ready(function(){
      ...
      if(TYPE == 'inHouseAttendance'){
        $txt = 'https://public.encom.app/customerInHouseAttendance?s=' . base64_encode( enc(COMPANY_ID) . ',' . enc(OUTLET_ID) . ',' . $oneHFuture );
      ...
      var options = {
          ...
          logo        : "https://ncmaspace.nyc3.cdn.digitaloceanspaces.com/assets/assets/images/Calcomania%205x5.png", 
