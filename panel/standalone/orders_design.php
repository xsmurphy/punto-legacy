    ...
    <div id="myCarousel" class="carousel slide " data-ride="carousel" data-interval="false">
      ...
      <div class="carousel-inner">
        ...
        <div class="text-center">
          <img src="https://panel.encom.app/images/bg_kds.png" width="100%" id="logoSaleList">
        </div>
...
<script type="text/javascript">
  ...
  var getAllTags = function(){
    ...
    postIt('https://api.encom.app/get_tags',vars,success);
  };

  var dataLoader = function(){
    var ordersUrl = 'https://api.encom.app/get_orders';
    var vars      = {
                      company_id  : '<?=enc(COMPANY_ID)?>',
                      api_key     : 'cc58c3ead1b111d48f5c0d677765f362e2a55598',
                      limit       : 20,
