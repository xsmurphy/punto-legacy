...
<head>
	...
	<title>ENCOM</title>
	<meta property="og:title" content="ENCOM" />
	...
	<link rel="stylesheet" href="https://panel.encom.app/css/style.css" type="text/css" />
	...
	<section class="vbox" id="content">
		...
		<div class="wrapper text-center col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-12">
			...
			<div class="m-b-md m-t-lg col-xs-12 animated bounceIn" id="encom">
				<a href="https://encom.app?utm_source=ENCOM_online_receipt&utm_medium=ENCOM_footer_icon&utm_campaign=Roquetas" class="block">
