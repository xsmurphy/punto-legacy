...
if(validateHttp('action') == 'generalTable'){
			...
			if($allow){
				...
				if($_rol == 'customer'){
					...
					$table .= 	'<tr data-id="' . $itemId . '" class="clickrow ' . $itemId . '">' .
								...
								'	<td>' . ($field['contactBirthDay'] ? niceDate($field['contactBirthDay']) : '') . '</td>' .
								'	<td data-order="' . $field['contactDate'] . '"> ' . niceDate($field['contactDate'],true) . ' </td>' .
								'	<td>' . $field['contactPhone'] . '</td>' .
	...
	if($_rol == 'customer'){
		$foot = '</tbody><tfoot><tr><td colspan="17"></td></tr></tfoot>';
	}
		...
		$.get(loadUrl,function(result){
			...
			if(_rol == 'customer'){
				...
				var tableColumns = [
										...
										{"index":6,"name":"Creado","visible":true},
										{"index":7,"name":'Teléfono',"visible":true},
										{"index":8,"name":'Teléfono 2',"visible":false},
										{"index":9,"name":'Email',"visible":true},
										{"index":10,"name":'Dirección',"visible":false},
										{"index":11,"name":'Localidad',"visible":false},
										{"index":12,"name":'Ciudad',"visible":false},
										{"index":13,"name":'Nota',"visible":false},
										{"index":14,"name":'Score',"visible":false},
										{"index":15,"name":'Loyalty',"visible":false},
										{"index":16,"name":'Distancia',"visible":false}
									];
			}
			if(_rol == 'supplier'){
				var sortBy = 4;
