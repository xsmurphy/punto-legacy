...
var ncmDTHideRows = 	function($selected,success,fail){
...
var ncmDataTables = function(options,callback){
	...
	var ncmTablesHTML = {
							...
							init : function(info,callback){
								...
								ncmTablesHTML.loadTo = ncmTablesHTML.opts.offset + ncmTablesHTML.opts.limit;
								...
								ncmHelpers.onClickWrap('#' + ncmTablesHTML.loadMoreBtn(),function(event,tis){
									...
									var xhr = ncmHelpers.load({
										...
										success 	: function(mdata){
											...
											ncmTablesHTML.loadTo = ncmTablesHTML.loadTo + ncmTablesHTML.opts.limit;
								...
								ncmHelpers.onClickWrap('#' + ncmTablesHTML.loadMoreBtn() + 'all',function(event,tis){
									...
									var xhr = ncmHelpers.load({
										...
										success 	: function(mdata){
											...
											ncmTablesHTML.loadTo 			= ncmTablesHTML.loadTo + ncmTablesHTML.loadBulkLimit;
