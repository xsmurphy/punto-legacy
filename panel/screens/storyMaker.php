...
<head>
  ...
  <link rel="stylesheet" href="/vendor.css?1.1.4.8" type="text/css">
  ...
  <div class="col-xs-12 wrapper fullHeight">
    <div class="halfHeight b b-white b-4x col-xs-12 wrapper-md r-3x text-center">
      ...
      <div class="col-xs-12 no-padder" style="height:30%;">
        <img src="/images/iconincomesmwhite.png" width="40" class="m-b-xs">
        <div class="h1" style="font-family: 'Kaushan Script', cursive;">
          ¡Bienvenidos!
        </div>
        <div class="m-t-xs font-bold">
          Ahora utilizan <?= APP_URL ?> <br> para hacer crecer su empresa
        </div>
      </div>
...
<!--<script type="text/javascript" src="/vendor.js?1.1.4.8"></script>-->
<script>
