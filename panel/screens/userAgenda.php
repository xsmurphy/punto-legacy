...
<body class="bg-light lter">
  <section class="col-xs-12 no-padder momentumit" id="content">
    ...
    <div class="wrapper text-center col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-12">
      <img height="40" width="40" src="/assets/150-150/0/<?=enc(COMPANY_ID)?>.jpg" class="img-circle m-r m-b animated bounceIn" id="logo" />
  ...
  <?php
  loadCDNFiles(['/assets/vendor/js/moment-2.24.0-with-locales.min.js',
