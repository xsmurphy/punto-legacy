...
if(validateHttp('pdf')){
	$apikey 	= PDF_API_KEY;
	$value 		= '/screens/digitalInvoice?s=' . $_GET['s'] . '&secret=iwfyita'; 
...
<body class="bg-light lter col-xs-12 no-padder">
	...
	<div class="wrapper col-lg-8 col-lg-offset-2 col-xs-12 m-t-md">
		...
		<div class="col-xs-6">
			<img height="60" width="60" src="/assets/150-150/0/<?=enc(COMPANY_ID)?>.jpg?<?=date('h')?>" class="img-circle pull-left" />
		...
		<div class="col-xs-12 no-padder clear m-t" id="list">
			...
			<div class="panel no-border col-xs-12 wrapper m-n">
				...
				<div class="col-sm-6 col-xs-12 no-padder">
					...
					<div class="col-xs-12 no-padder">
					    <div class="font-bold">
					    	<?=L_POWERED_BY?> <a href="/">WWW.ENCOM.APP</a>
					    </div>
					</div>
				</div>
	...
	<script src="/scripts/dpb.min.js"></script>
