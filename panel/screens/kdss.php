...
$setting = ncmExecute("SELECT settingThousandSeparator,settingDecimal,settingCurrency,settingTimeZone,settingName FROM company WHERE companyId = ? LIMIT 1",[COMPANY_ID]);
...
if(validateHttp('action') == 'manifest'){
  ...
  "lang": "es",
  "dir": "ltr",
  "short_name": "<?= APP_NAME ?> KDS",
  "theme_color": "#405161",
  "background_color": "#405161",
  "start_url": "/screens/kds?s=<?=validateHttp('s')?>",
  "scope": "/screens/kds?s=<?=validateHttp('s')?>",
  "display": "fullscreen",
  "orientation": "natural",
...
<head>  
  ...
  loadCDNFiles([
    ...
    '/assets/vendor/css/offline-language-spanish.min.css',
    '/assets/vendor/css/offline-theme-dark.min.css',
  ...
  <style type="text/css">
    ...
    body{
      background-image: url(/assets/panel/images/logotextgray.png); 
...
<body class="noscroll">
    ...
    <div id="ordersList" class="carousel slide " data-ride="carousel" data-interval="false">
      ...
      <div class="carousel-inner">
        ...
        <div class="text-center">
          <img src="/images/bg_kds.png" class="hidden" width="100%" id="logoSaleList">
        </div>
  ...
  loadCDNFiles([
                  ...
                  '/assets/vendor/js/moment-locale-es.js',
                  ...
                  '/assets/vendor/js/offline-0.7.19.min.js',
                  '/assets/vendor/js/sweetalert2-7.33.1.min.js',
                  '/assets/vendor/js/push-1.0.8.min.js'
                ],'js');
  ?>
<script type="text/javascript">
