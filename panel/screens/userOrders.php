...
?>
  ...
  <script type="text/html" id="noDataTpl">
    <?=noDataMessage('No tiene órdenes','No tiene órdenes pendientes','/assets/images/emptystate7.png')?>
  </script>

  <script type="text/html" id="noGpsTpl">
    <?=noDataMessage('Habilite su GPS','Para poder mostrar los pedidos necesita permitir el acceso al GPS','/assets/images/emptystate7.png')?>
  </script>
