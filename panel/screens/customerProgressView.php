    ...
    <div class="col-xs-12 wrapper bg-light lter"> 
      ...
      <div class="text-left" style="display: block; position: relative;margin: 0 auto; max-width: 700px;">
        ...
        <div class="col-xs-12 wrapper text-center hidden-print">
          <a href="/screens/customerProgressView?s=<?=$_GET['s']?>" class="nativeA" target="_blank">Ver versión independiente</a>
        </div>
...
<?php
loadCDNFiles(['/assets/vendor/js/Chart-2.9.4.min.js','/assets/vendor/js/chartjs-plugin-annotation-0.5.7.min.js'],'js');
?>
<script>
