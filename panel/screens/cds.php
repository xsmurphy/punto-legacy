...
if(validateHttp('action') == 'manifest'){
  ?>
  {
    ...
    "lang": "es",
    "dir": "ltr",
    "short_name": "<?= APP_NAME ?> CDS",
    "theme_color": "#405161",
    "background_color": "#405161",
    "start_url": "/screens/cds?s=<?=validateHttp('s')?>",
    "scope": "/screens/cds?s=<?=validateHttp('s')?>",
    "display": "fullscreen",
    "orientation": "natural",
    ...
    <section class="bodyBlock">
      ...
      <div class="col-xs-12 wrapper-sm bg-dark" style="position: fixed; z-index:100; bottom:0;">
        <div class="col-xs-6 no-padder">
          <img src="/images/incomeLogoLgGray.png" height="30">
        </div>
