...
$iMap = (!$lat) ? '' : '<iframe width="100%" height="200" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" id="iMap" src="/screens/mapIframe?height=200&lat=' . $lat . '&lng=' . $lng . '&theme=' . $mapTheme . '&zoom=15&key=CNOdLR0O-IxjQLm0jNZl79mpvbH1W59sgVcDP_dufu8&icon=' . $icon . '"></iframe>';
