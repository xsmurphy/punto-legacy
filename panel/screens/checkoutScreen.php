...
if(validateHttp('action') == 'manifest'){
  ?>
  {
    "name": "<?= APP_NAME ?> Display",
    "lang": "es",
    "dir": "ltr",
    "short_name": "<?= APP_NAME ?> Display",
    "theme_color": "#62bcce",
    "background_color": "#62bcce",
    "start_url": "/screens/checkoutScreen?s=<?=validateHttp('s')?>",
    "scope": "/screens/checkoutScreen?s=<?=validateHttp('s')?>",
    "display": "fullscreen",
...
<body class="bg-info lt">
  ...
  <script id="titleTpl" type="text/html">
    ...
    <div class="col-xs-12 no-padder m-t-md text-center">
        ...
        <img src="/images/logotextwhite.png" height="60"> <br>
        <span class="text-muted font-bold"><?= APP_URL ?></span> 
    </div>
    ...
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-8 text-white wrapper-lg text-left title noPortrait">
      ...
      <div class="col-xs-12 text-center visible-xs">
        <img src="/assets<?=$companyLogo;?>" width="50" height="50" class="m-b rounded">
      </div>
    ...
    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-4 no-padder text-right qr noPortrait" >
      ...
      {{^hasItems}}
        <div class="col-xs-12 no-padder m-t text-center">
          <img src="/assets<?=$companyLogo;?>" width="100" height="100" class="m-b rounded hidden-xs">
          <div class="text-white text-xs">Usamos</div>
          <img src="/images/logotextwhite.png" height="20" width="80">
        </div>
      {{/hasItems}}
    </div>
...
<?php
loadCDNFiles([
  '/assets/vendor/js/handlebars-4.7.7.min.js'
],'js');
?>
