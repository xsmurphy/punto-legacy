...
$companyCategories	= require __DIR__ . "/../libraries/company_categories.php";
...
$globals = ['COMPANY_ID','USER_ID','MASTER_COMPANY_ID','USER_NAME','USER_EMAIL','USER_ID','USER_PHONE','COMPANY_NAME','COMPANY_DATE','PLAN','OUTLETS_COUNT','OUTLET_ID','REGISTER_ID'];
