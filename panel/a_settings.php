...
if(validateHttp('action') == 'sortCategories' || (!empty($_POST['action']) && $_POST['action'] == "sortCategories")){

  if(validateHttp('update') || !empty($_POST['update'])){
    $data = json_decode( base64_decode( (!empty(validateHttp('update')) ? validateHttp('update') : $_POST['update']) ), true );
...
<input type="hidden" class="flagSave" value="no-active">
                ...
                <div class="row clear">
                  ...
                  <div class="col-xs-12 m-b m-t-md font-bold text-u-c">
                          ...
                          <div class="col-sm-4 col-xs-12 no-padder text-right">
                            <select id="taxAdd" name="tax" tabindex="1" data-placeholder="Seleccione" class="form-control tax no-bg no-border b-b b-light" autocomplete="off">
                              ...
                              if($tax){
                                while (!$tax->EOF) {
                                  $fields = $tax->fields;
                                  $taxId  = enc($fields['taxonomyId']);
                              ?>
                              <option value="<?=$taxId;?>"><?=$fields['taxonomyName'] ? $fields['taxonomyName'] : 'Exento';?></option>
                              <?php 
                                  $tax->MoveNext(); 
                                }
                                $tax->Close();
                    ...
                    <div class="col-xs-12 no-padder animated fadeIn speed-4x" id="settingsRegisterBlock">
                      ...
                      <div class="col-xs-12 wrapper b-b">
                        <div class="col-sm-8 col-xs-12 no-padder m-t-sm">Lector de códigos de balanza <i class="material-icons text-muted m-l-xs pointer md-16" data-toggle="tooltip" data-placement="top" title="Puede escanear los códigos de barra de las balanzas electrónicas.">help_outline</i></div>
                        <div class="col-sm-4 col-xs-12 no-padder text-right">
                        <?php
                          echo switchIn('weightBarcodes',(validity($_fullSettings['weightBarcodes']) ? true : false));
                        ?>
                        </div>
                      </div>
                  ...
                  <div class="col-xs-12 wrap-l-n wrap-r">
                    <section class="panel panel-default">
                      ...
                      <div class="list-group no-radius alt collapse" id="collapseOtros">
                        ...
                        <a class="addField list-group-item receiptableN" data-type="ver_line" data-default="" href="#" data-toggle="tooltip" data-placement="right" title="Inserte una línea vertical">Línea Vertical</a>
                    ...
                    <section class="panel panel-default">
                      ...
                      <div class="list-group no-radius alt collapse" id="collapseEmpresa">
                        <a class="addField list-group-item" data-type="company_logo" data-default="<?=imageToBase64(companyLogo(200))?>" href="#">Logo</a>
                        <a class="addField list-group-item" data-type="company_logo" data-default="<?=imageToBase64(companyLogo(200,true))?>" href="#">Logo (B&W)</a>
                        ...
                        <a class="addField list-group-item" data-type="outlet_name" data-default="Nombre - Sucursal" href="#">Nombre - Sucursal</a>
                        <a class="addField list-group-item" data-type="outlet_billing_name" data-default="Razón social - Sucursal" href="#">Razón social - Sucursal</a>
                        <a class="addField list-group-item" data-type="outlet_tin" data-default="<?=TIN_NAME?> - Sucursal" href="#"><?=TIN_NAME?> - Sucursal</a>
                        <a class="addField list-group-item" data-type="outlet_address" data-default="Dirección - Sucursal" href="#">Dirección - Sucursal</a>
                        <a class="addField list-group-item" data-type="outlet_phone" data-default="Teléfono de Sucursal" href="#">Teléfono - Sucursal</a>
                    ...
                    <section class="panel panel-default">
                      ...
                      <div class="list-group no-radius alt collapse" id="collapseTransaccion">
                        ...
                        <a class="addField list-group-item" data-type="associated_document" data-default="######" href="#">Documento Asociado</a>
                        <?php 
                        $tax = ncmExecute('SELECT taxonomyId, taxonomyName FROM taxonomy WHERE taxonomyType = "tax" AND '.$SQLcompanyId.' ORDER BY taxonomyName ASC',[],false,true);
                    ...
                    <section id="boxOpsWrap" class="hidden">
                      <div class="font-bold text-u-c">
                        Opciones
                      </div>
                      <div>
                        <span class="font-bold text-xs">Izquierda</span>
                        <input type="text" name="" class="form-control m-b-sm boxOpsLeft">

                        <span class="font-bold text-xs">Arriba</span>
                        <input type="text" name="" class="form-control m-b-sm boxOpsTop">

                        <span class="font-bold text-xs">Ancho</span>
                        <input type="text" name="" class="form-control m-b-sm boxOpsWidth">

                        <span class="font-bold text-xs">Alto</span>
                        <input type="text" name="" class="form-control m-b-sm boxOpsHeight">
                      </div>
                    </section>
...
?>
  ...
  $(() => {
    ...
    submitForm('#editSetting',function(element,id){
    ...
    ncmHelpers.onClickWrap('a.setCurrenciesBtn',function(event,tis){
      $.get(baseUrl + '?action=setCurrencies',function(data){
        ...
        $.each(data,function(i,val){
          ...
          if(val.value > 0){
            table +='     <div class="text-xs text-right currencyExp' + val.code + '">1 ' + val.code + ' = ' + val.value + ' ' + currency + '</div>';
          }
            table +='   </td>' +
                    '</tr>';
        });
