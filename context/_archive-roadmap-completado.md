<!-- ARCHIVE — items del roadmap ya cerrados. NO es contexto vivo.
     Solo referencia histórica para entender qué se hizo y por qué.
     Roadmap vivo: 10-roadmap.md -->

# Archive — Roadmap completado (referencia histórica)

Items completados del roadmap del proyecto Punto POS. Se archivaron el 2026-06-16
para reducir el costo de tokens del contexto vivo.
...
## Admin realm — notas técnicas detalladas (F0..F3.5 + F4/F5/F6)
...
| 3 | ✅ `App\Helpers\Validation` (validity+validateBool+validateHttp+validateResultFromDB — 2298 callers, linchpin) | 8 |
| 4 | ✅ `App\Helpers\Str` (toUtf8, markupHtml, isHtml, tryBase64Decode — 268 callers) | 8 |
| 5 | ✅ `App\Helpers\Date` (niceDate, niceDate2, getNextDatePeriod, dateStartEndTime, translateNamesOfWeek — 185 callers) | 8 |
